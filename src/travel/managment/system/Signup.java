...
public class Signup extends JFrame implements ActionListener{
	...
	Signup(){
		...
		security = new Choice();
		security.add("Your Favourite Character ");
		security.add("Your Favourite Marvel Character ");
		security.add("Your Luckey number");
		security.add("Your House Number");
		...
		create.setFont(new Font("TIMES NER ROMAN", Font.BOLD,15));
		...
		back.setFont(new Font("TIMES NER ROMAN", Font.BOLD,15));
